# Get Started with Pub/Sub: Challenge Lab || [ARC113](https://www.cloudskillsboost.google/course_templates/728/labs/461595) ||

### Run the following Commands in CloudShell
### From "Lab Panel" you can find your REGION,
```
export REGION=
```
